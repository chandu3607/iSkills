...
export default function CourseRoadmap() {
  const steps = [
    {
      text: " Learn fundamentals of HTML, CSS with basics of SQL  ",
      className: "left-[2.7vw] top-[10vw]",
      glow: "#F3641F",
      hover: "from-[#F3641E] to-[#CB4037]",
    },
    {
      text: " Deep dive into Databases and Ace Mobile responsive pages along with MongoDB",
      className: "left-[20.9vw] top-[20.4vw]",
      glow: "#6362AE",
      hover: "from-[#6362AE] to-[#28347E]",
    },
    {
      text: " Ace mobile responsive pages and optimisation along with GitHub fundamentals  ",
      className: "left-[34.2vw] top-[4vw]",
      glow: "#31D49D",
      hover: "from-[#31D49D] to-[#1E8678]",
    },
    {
      text: " Get started with Important javascripts Node, react, angular, express ",
      className: "left-[53vw] top-[14vw]",
      glow: "#5FC9F0",
      hover: "from-[#84D8F3] to-[#3C65B5]",
    },
    {
      text: "Develop real time projects and build a professional portfolio",
      className: "left-[68vw] top-[-3vw]",
      glow: "#9B3DA8",
      hover: "from-[#9E3BA8] to-[#7552A1]",
    },
    {
      text: " Get job ready with Placement Assistance Resume Support | Mock interviews  ",
