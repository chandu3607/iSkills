...
const skills = [
  {
    name: "HTML",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/html-5.png",
  },
  {
    name: "CSS",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/css-3.png",
  },
  {
    name: "SQL",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/MongoDB.svg",
  },
  {
    name: "Express Js",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/express js.svg",
  },
  {
    name: "Node Js",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/Node Js.svg",
  },
  {
    name: "React Js",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/React js.svg",
  },
  {
    name: "Angular Js",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/Angular Js.svg",
  },
  {
    name: "UI/Ux",
    icon: "https://media.iquanta.in/ui_images/skills/full-stack/designer.png",
  },
