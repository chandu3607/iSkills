const benefits = [
  {
    ...
    title: "Average hike",
    description:
      "A significant jump for learners transitioning into high-demand full stack roles across tech-driven companies.",
  ...
  },
  {
    ...
    description:
      "A competitive compensation range reflecting strong demand for skilled full stack engineers in modern startups and enterprises.",
    icon: "https://media.iquanta.in/ui_images/skills/benefit-icon-2.svg",
    accent: "from-[#127EF1]/28 via-[#127EF1]/8 to-transparent",
  },
  {
    stat: "Widely used ",
    title: "skills across industries",
    description:
      "From fintech to edtech, full stack developers are essential in building scalable, end-to-end digital products.",
  ...
  },
  {
    ...
    description:
      "Consistent growth as developers gain expertise in frontend, backend, and system design.",
