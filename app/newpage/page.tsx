...
export default function page() {
  return (
    <>
      ...
      <main className="">
        <div className="rounded-4xl h-screen relative block w-full bg-[linear-gradient(182deg,rgba(255,255,255,1)_0%,rgba(233,243,253,1)_100%)]">
          <Ballpit        
            minSize={0.3}
            maxSize={1}
            count={120}
            ...
            materialParams={{ metalness: 0.1, roughness: 0.3, clearcoat: 1, clearcoatRoughness: 0.4,}} />
