const features = [
  ...
  {
    name: "1:1 live doubt-solving",
    premium: true,
    gold: false,
    others: false,
  },
  {
    name: "Live project classes",
    premium: true,
    gold: true,
    others: false,
  },
  {
    name: "Personalized resume support",
    premium: true,
    gold: false,
    others: false,
  },
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-10 text-center max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 mt-2 md:text-[16px] text-[14px] md:px-0 px-4">
            Our data analytics program is not only updated on the curriculum but
