...
const benefits = [
  {
    title: "Data Analyst",
    description:
      "A powerful starting point for learners aiming to turn raw data into meaningful insights and real business impact.",
  ...
  },
  {
    ...
    description:
      "Work with dashboards, reports, and KPIs to help organizations make smarter, data-driven decisions at scale.",
  ...
  },
  {
    title: "Business intelligence analyst",
    description:
      "Build expertise across tools and techniques that apply to multiple industries where data drives performance.",
    icon: "https://media.iquanta.in/ui_images/skills/benefit-icon-3.svg",
    accent: "from-[#61E6C6]/28 via-[#61E6C6]/8 to-transparent",
  },
  {
    title: "Sales Analyst / HR Analyst / Operations Analyst / Financial Analyst",
    description:
      "Unlock opportunities across domains as your analytics skills translate into consistent growth and career progression.",
