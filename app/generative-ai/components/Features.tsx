const features = [
  {
    ...
    title: "Live sessions",
    desc: "Cover data analytics syllabus from basics to advanced by industry experts",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-2.svg",
    title: "Domain specific live projects",
    desc: "5+ end-to-end live projects in data analytics course.",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-3.svg",
    title: "1-On-1 doubt solving",
    desc: "Access 1-On-1 support from data analytics experts.",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-4.svg",
    title: "Dashboard  With Recordings",
    desc: "Access session recordings and projects in the data analytics course.",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-5.svg",
    title: "Placement assistance",
    desc: "Get resume support and showcase your data analytics certification skills.",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-6.svg",
    title: "Career support",
    desc: "Build your skills with data analytics training while we handle your job search.",
  },
];
    ...
    <section className="bg-black md:py-10 py-6">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="overflow-x-auto md:overflow-visible"
          style={{scrollbarWidth: "none",  scrollbarColor: "#EFD4CB #1a1a1a", }}>
          <div
            className="
              flex md:grid
              md:grid-cols-3
