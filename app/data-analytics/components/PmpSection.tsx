    ...
    <div className="max-w-6xl mx-auto px-4 relative z-10">
      <div className="grid md:grid-cols-12 grid-cols-1 gap-8 md:gap-16 items-center">
        <div className='md:col-span-7'>
          ...
          ">
            Complete Data Analytics Course: Master Industry-Relevant Skills for Success
          </h2>

          <h6 className="text-[#EDEEF1] text-[13px] sm:text-[14px] md:text-[15px] italic font-semibold leading-6 sm:leading-7 md:leading-8.75">
            No prerequisite knowledge needed | Learn from the very basics to the advanced level
          </h6>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
            This data analytics course is your gateway to mastering advanced skills, from analyzing data to uncovering insights that solve real-world business challenges.
          </p>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
            With hands-on data analytics training, you’ll build confidence to make smarter decisions and handle complex scenarios effortlessly.
          </p>
            ...
            <div className="
              ...
              ">
                {[
                  ...
                  "Gain real-world experience with domain-specific projects",
                  "Master 6+ technologies to be job ready",
                  "Earn your data analytics course certification",
                  "Create interactive dashboards for in-depth data analysis",
                  "Solve complex business problems and use cases.",
                ].map((item, i) => (
