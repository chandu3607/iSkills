const features = [
  {
    ...
    title: "Live sessions",
    desc: "120+ hours of interactive live and recorded sessions from basics to advance",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-2.svg",
    title: "Domain specific live projects",
    desc: "Choose projects from Industry relevant domain",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-3.svg",
    title: "1-On-1 doubt solving",
    desc: "12 hours daily 1 to 1 live support with experts",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-4.svg",
    title: "Dashboard Access With Recordings",
    desc: "Get all your recorded conttent, Assignments and study material even post course completion based on your plan",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-5.svg",
    title: "Placement assistance",
    desc: "Get resume support & Mock interview preparation to showcase the skills you have earned  ",
  },
  {
    icon: "https://media.iquanta.in/ui_images/skills/feature-6.svg",
    title: "Career support",
    desc: "No need to hunt for jobs, focus on building you skills while we do the rest ",
  },
];
