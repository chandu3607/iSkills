      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto mb-10">
          ...
          <p className="text-gray-400 mt-2 md:text-[16px] text-[14px] md:px-0 px-4">
           Join our DSA & Competitive Programming community for exclusive masterclasses, study materials, and networking with peers. Unlock job openings and enhance your coding skills.
          </p>
        </div>
