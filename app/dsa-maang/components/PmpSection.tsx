      ...
      <div className="grid md:grid-cols-12 grid-cols-1 gap-8 md:gap-16 items-center">
        <div className='md:col-span-7'>
          ...
          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
            Data structures algorithms is a very vital aspect of tech development when it comes to creating complex solutions, not only does strong abilities in DSA significantly improve your chances of cracking MAANG interviews but it also ensure robust development by improving decision making abilities, improves coding skills to a great extent and makes computation of complex solutions efficient and run faster. 
          </p>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
          Weather you are trying to get a good campus placement or making a switch to MAANG this course has you covered from the very basics to the advance level.
          </p>
            ...
            <div className="
              ...
              ">
                {[
                  ...
                  " Get interview ready for MAANG organisation ",
