const benefits = [
  {
    ...
    description:
      "A sharp boost in coding and problem-solving ability for product-based company interviews.",
  ...
  },
  {
    ...
    description:
      "Aligned with compensation offered by top product companies like MAANG-level firms.",
  ...
  },
  {
    ...
    description:
      "Master DSA, problem patterns, and coding strategies needed to crack high-level interviews.",
  ...
  },
  {
    ...
    description:
      "Consistent career growth as experience and domain expertise increase.",
