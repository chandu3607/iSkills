...
export default function CourseRoadmap() {
  const steps = [
    {
      text: " Basic Techniques ( Time Complexity + Mathematical Problems + Bitwise Manipulation + Recursion + Backtracking)   ",
      className: "left-[7.7vw] top-[12vw]",
      glow: "#F3641F",
      hover: "from-[#F3641E] to-[#CB4037]",
    },
    {
      text: "Master Data Structures ( Arrays + Linked List + Stack + Queue + Trees + Graphs) ",
      className: "left-[33.9vw] top-[20.4vw]",
      glow: "#6362AE",
      hover: "from-[#6362AE] to-[#28347E]",
    },
    {
      text: " Sorting and Searching ( Sorting Techniques + Searching Techniques + Hashing + Strings) ",
      className: "left-[54.2vw] top-[4vw]",
      glow: "#31D49D",
      hover: "from-[#31D49D] to-[#1E8678]",
    },
    {
      text: "Advanced Data Structures and Techniques ( Trees + Graphs + Greedy Techniques + Dynamic Programming ).  ",
      className: "left-[82vw] top-[11vw]",
      glow: "#5FC9F0",
    ...
    <section className="bg-black md:py-10 py-6 ">
      ...
      <div className="relative hidden md:block">
        <div className="relative z-10">
          <img
            src="https://media.iquanta.in/ui_images/skills/dsa-pattern-roadmap.png"
            className="w-full"
          />
        </div>
        {steps.map((step, i) => (
