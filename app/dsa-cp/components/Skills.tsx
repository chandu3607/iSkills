...
const skills = [
  { name: "Asymptotic Notations", icon: "https://media.iquanta.in/ui_images/skills/Asymptotic%20notations.svg" },
  { name: "Arrays", icon: "https://media.iquanta.in/ui_images/skills/Arrays%201.svg" },
  { name: "Backtracking", icon: "https://media.iquanta.in/ui_images/skills/Backtracking.svg" },
  { name: "Binary Tree", icon: "https://media.iquanta.in/ui_images/skills/Binary%20Tree.svg" },
  { name: "Counting Sort", icon: "https://media.iquanta.in/ui_images/skills/Counting%20sort.svg" },
  { name: "Disjoint Sets", icon: "https://media.iquanta.in/ui_images/skills/Disjoint%20Sets.svg" },
  { name: "Dynamic Programming", icon: "https://media.iquanta.in/ui_images/skills/Dynamic%20Programming.svg" },
  { name: "Graphs", icon: "https://media.iquanta.in/ui_images/skills/Graph.svg" },
  { name: "Greedy Techniques", icon: "https://media.iquanta.in/ui_images/skills/Greedy%20Techniques .svg" },
  { name: "Hashing", icon: "https://media.iquanta.in/ui_images/skills/Hashing%20-%20Foundation.svg" },
  { name: "Heaps", icon: "https://media.iquanta.in/ui_images/skills/Heaps.svg" },
  { name: "Kadane's Algorithm", icon: "https://media.iquanta.in/ui_images/skills/Kadanes%20algorithm.svg" },
  { name: "Linked List", icon: "https://media.iquanta.in/ui_images/skills/Linked%20List.svg" },
  { name: "Minimum Spanning Tree", icon: "https://media.iquanta.in/ui_images/skills/Minimum%20Cost%20Spanning%20tree.svg" },
  { name: "Prefix Sum", icon: "https://media.iquanta.in/ui_images/skills/Prefix%20sum%20technique.svg" },
  { name: "Radix Sort", icon: "https://media.iquanta.in/ui_images/skills/Radix%20Sort.svg" },
  ...
  { name: "Searching Techniques", icon: "https://media.iquanta.in/ui_images/skills/Searching%20Techniques.svg" },
  ...
  { name: "Two Pointer Technique", icon: "https://media.iquanta.in/ui_images/skills/Two%20Pointer%20technique.svg" },
  { name: "Sliding Window", icon: "https://media.iquanta.in/ui_images/skills/Sliding%20Window.svg" },
];
