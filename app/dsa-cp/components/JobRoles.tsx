...
const benefits = [
  {
    ...
    description: "Build strong problem-solving skills using data structures and algorithms to develop efficient and scalable software solutions.",
  ...
  },
  {
    ...
    description: "Design and optimize applications with clean logic, efficient algorithms, and performance-focused coding practices.",
    icon: "https://media.iquanta.in/ui_images/skills/benefit-icon-2.svg",
    accent: "from-[#127EF1]/28 via-[#127EF1]/8 to-transparent",
  },
  {
    title: "Algorithm Engineer ",
    description: "Solve complex computational problems by designing optimized algorithms and advanced data structure solutions.",
  ...
  },
  {
    ...
    description:  "Architect scalable systems and guide teams using deep expertise in algorithms, system design, and performance optimization.",
         ...
         style={{
          ...
          <div
            className="
                ...
                shrink-0 md:shrink">
                <div  className={`absolute inset-0 bg-linear-to-br ${benefit.accent} opacity-90`}/>
