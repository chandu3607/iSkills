  ...
  return (
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto mb-10">
         ...
         Join free Coding Community – Start DSA & CP Journey ! 
          </h2>
          <p className="text-gray-400 mt-2 md:text-[16px] text-[14px] md:px-0 px-4">
           Join the best DSA course online and explore the free coding community today for exclusive masterclasses, study materials, and networking! Unlock Job opportunities and elevate your competitive coding skills.
          </p>
        </div>
            ...
            <div className="border border-[rgba(209,209,209,0.3)] rounded-[30px]">
              <div className="border-[7px] border-white/15 rounded-[30px] bg-black p-3.75">
                <div className="overflow-hidden rounded-[10px]">
                  <img
                    src="https://media.iquanta.in/ui_images/skills/commu-dsa-cp.jpeg"
