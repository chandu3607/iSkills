const features = [
  ...
  {
    name: "Daily Competitive Programming Practice Problems ",
    premium: true,
    gold: true,
    others: false,
  },
  {
    name: "Daily Competitive Programming Practice (Live Solution)",
    premium: false,
    gold: true,
    others: false,
  },
  {
    name: "Competitive Programming Competitions",
    premium: true,
    gold: true,
    others: false,
  },
  {
    name: " DSA Questions in Multiple Patterns ",
    premium: true,
    gold: true,
    others: false,
  },
...
const renderCell = (value: boolean | string | { type: string; text: string }) => {
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-10 text-center max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 mt-2 md:text-[16px] text-[14px] md:px-0 px-4">
            Our DSA and Competitive Programming is not only updated on the curriculum but
            also contains every winning formula required to make you a skilled in
            DSA and Competitive Programming.
          </p>
        </div>
        <div
          className="bg-[#1d1e21] p-4 sm:p-6 md:p-[37px_30px_30px] rounded-[20px] overflow-x-auto"
          style={{
            scrollbarWidth: "none",
