    ...
    <div className="max-w-6xl mx-auto px-4 relative z-10">
      <div className="grid md:grid-cols-12 grid-cols-1 gap-8 md:gap-16 items-center">
        <div className='md:col-span-7'>
          ...
          ">
          Master DSA and Competitive Programming with C++/Python/Java Certification 
          </h2>

          <h6 className="text-[#EDEEF1] text-[13px] sm:text-[14px] md:text-[15px] italic font-semibold leading-5 sm:leading-7 md:leading-8.75">
          Prerequisite: Basic Programming Knowledge | Suitable for C++, Java, or Python.
          </h6>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
           Data structures and algorithms are essential for cracking tech interviews, building scalable systems, and improving programming skills. 
          </p>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
          While competitive programming is of top most priority if you aspire to work for major product development companies or MAANG companies.
          </p>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
           This online DSA and CP course helps you build a strong foundation for a successful development career with : 
          </p>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
          1- DSA Basics to Advanced Concepts 
          </p>
          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
           2- Competitive Programming  
          </p>
           {/* <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
          You’ll also join live competitive programming contests with mentor guidance to improve your ranking and create a portfolio that opens doors to great jobs.
          </p> */}
           {/* <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
           Get daily practice problems and live nightly solutions, so you’ll never be alone in your online dsa course journey.
          </p> */}
        ...
        <div className='md:col-span-5'>
          <div className="
            ...
            <div className="
              ...
              ">
                {[
                  "Learn DSA and solve multiple pattern questions",
                  " Learn DSA and solve multiple pattern questions",
                  " Daily competitive programming practice questions with live solutions",
                  " Daily live doubt-clearing classes  ",
                  "300+ live problem-solving sessions ",
