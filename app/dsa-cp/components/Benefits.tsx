const benefits = [
  {
    ...
    description:
      "Unlock roles in product-based companies with strong DSA and competitive coding skills.",
  ...
  },
  {
    ...
    description:
      "Write optimized and faster solutions using advanced algorithms and patterns.",
  ...
  },
  {
    ...
    description:
      "Excel in coding contests with strong problem-solving and time management skills.",
    icon: "https://media.iquanta.in/ui_images/skills/benefit-icon-3.svg",
    accent: "from-[#61E6C6]/28 via-[#61E6C6]/8 to-transparent",
  },
  {
    stat: "Success rate",
    title: "Interview cracking",
    description:
      "Improve your chances of clearing coding rounds with consistent practice and strategy.",
