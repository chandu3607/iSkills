...
const benefits = [
  {
    ...
    description:
      "Turn raw data into actionable insights using Python, statistics, and machine learning to solve real-world business problems.",
  ...
  },
  {
    ...
    description:
      "Lead data-driven strategies, build advanced models, and translate complex data into impactful business decisions.",
  ...
  },
  {
    title: "Ai Engineer",
    description:
      "Design and deploy intelligent systems using machine learning, deep learning, and real-world AI applications.",
  ...
  },
  {
    title: "ML Engineer",
    description:
      "Build, optimize, and deploy scalable machine learning models into production systems.",
