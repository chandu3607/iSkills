      ...
      <div className="grid md:grid-cols-12 grid-cols-1 gap-8 md:gap-16 items-center">
        <div className='md:col-span-7'>
          ...
          <h6 className="text-[#EDEEF1] text-[13px] sm:text-[14px] md:text-[15px] italic font-semibold leading-6 sm:leading-7 md:leading-8.75">
            No Prerequisites | Real-time projects 
          </h6>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
            Learn the complete Data Science and Ai stack from basics to advance. Build real time skills and know how they are applied in practical environments. 
          </p>

          <p className="text-[#EDEEF1] text-[14px] sm:text-[15px] md:text-[16px] leading-6">
           Knowledge in Data science will assist you to drive efficient business processes and build vital solutions used for solving real industry problems.
          </p>
            ...
            <div className="
              ...
              ">
                {[
                  ...
                  " 1 on 1 live doubt solving",
                  " Complete Ai stack | Machine learning, Deep learning, Computer vision & NLP",
                  " Learn 6+ technologies to get job ready",
                  " Build real world Ai solutions via practical projects",
