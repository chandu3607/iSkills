const benefits = [
  {
    ...
    title: "Average hike",
    description:
      "A massive jump as learners transition into high-demand data roles across industries.",
  ...
  },
  {
    ...
    description:
      "Competitive packages aligned with data-driven roles in startups, MNCs, and product companies.",
  ...
  },
  {
    ...
    description:
      "Master tools like Python, SQL, Machine Learning, and real-world data problem solving.",
