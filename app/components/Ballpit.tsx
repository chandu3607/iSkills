...
// ✅ FIX 1: Default colors changed from [0, 0, 0] (pure black = invisible) to visible colors
const XConfig = {
  count: 200,
  colors: [0xff6030, 0xffaa00, 0x20aaff, 0xaa44ff, 0x44ffaa],
...
const Ballpit: React.FC<BallpitProps> = ({ className = '', followCursor = true, ...props }) => {
  ...
  }, [followCursor, props.count, props.gravity, props.friction, props.wallBounce, colorsKey]);
