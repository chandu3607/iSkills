  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute md:right-3 right-0 md:top-3 -top-2 z-20 flex h-7 w-7 items-center justify-center rounded-full border md:border-white/10 border-white/90 md:bg-black/5 bg-black md:text-black/75 text-white transition-colors duration-200 hover:bg-black/8 hover:text-black"
