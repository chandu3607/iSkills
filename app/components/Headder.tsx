  ...
  return (
    <>
      <header className="fixed top-0 w-full z-999">
        <div className="bg-[linear-gradient(90deg,rgba(236,236,236,0.06)_0%,rgba(137,137,137,0.06)_100%)] backdrop-blur-xl md:rounded-b-[50px] rounded-b-[20px]">
          ...
          {isMenuOpen && (
            <div className="lg:hidden px-6 pb-6 text-white md:space-y-4 space-y-3">
              <div>
                ...
                {mobileDropdown && (
                  <div className="mt-2 space-y-3 pl-1 text-sm text-gray-300">
                    {[
                      { name: "Data Analytics", path: "/data-analytics" },
                      {
                        name: "Full Stack Web Development",
              ...
              <Link href="https://www.iquanta.in/blog/" target="_blabk">
                <button className="text-white text-md">Blog</button>
              </Link>

              <div
                className="text-md m-0 py-2"
                onClick={() => setIsContactOpen(true)}
              >
                Contact Us
              </div>
              <Link href="/login">
                <button className="text-white text-md">Login</button>
              </Link>
