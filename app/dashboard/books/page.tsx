  ...
  MBA: [
    {
      ...
      description: "12 Sets of CAT Material updated as per CAT 2023 Standards",
      href: "/best-cat-books",
    },
  ],
  "After 12th": [
        ...
        <div className="relative space-y-2">
          <nav className="text-sm text-slate-500">
            <ol className="flex items-center gap-2">
              ...
              <li>/</li>
              <li className="font-medium text-slate-700">Books</li>
            </ol>
          </nav>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900 md:text-3xl">Books</h1>
