...
const categories: Category[] = ["MBA", "After 12th", "IIT JEE", "NEET", "banking"];

const allMocks: Record<Category, MockItem[]> = {
  MBA: [
    { title: "iCAT Mocks", desc: "iCAT 1.0 & 2.0 is Free!", link: "/cat-mock-test" },
    { title: "XAT Mocks", desc: "XAT 1.0 is Free!", link: "/xat-mock-test" },
    { title: "NMAT", desc: "", link: "/nmat-mock-test" },
    { title: "SNAP", desc: "", link: "/snap-mock-test" },
    { title: "CMAT", desc: "CMAT 1.0 is Free!", link: "/cmat-mock-test" },
    { title: "MICAT", desc: "MICAT 1.0 is Free!", link: "/micat" },
    { title: "CUET PG", desc: "CUET PG 1.0 is Free!", link: "/cuet-pg-mock-test" },
    { title: "MHCET", desc: "MHCET PG 1.0 is Free!", link: "/mahcet-mock-test" },
    { title: "PGDBA", desc: "PGDBA PG 1.0 is Free!", link: "/pgdba" },
  ],
  "After 12th": [
