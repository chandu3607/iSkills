      ...
      <section className="grid gap-4 xl:grid-cols-12">
        <article className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 xl:col-span-8">
          <div className="mb-4 flex justify-between items-center">
            ...
            <Link href="/dashboard/exam-details">
              <button className=" cursor-pointer  flex items-center gap-2 px-4 py-2 text-xs rounded-full border border-slate-200 bg-[#f6f6f6]  text-slate-600 transition hover:bg-gray-100 hover:text-slate-900"> <MoveLeft className="w-4 h-4" /> Back to Overview</button>
            </Link>
          </div>
