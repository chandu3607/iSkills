...
const contactChannels = [
  ...
  },
  {
    ...
    icon: Mail,
    link: "mailto:support@iquanta.in",
  },
  {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-6 w-full">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs sm:text-sm text-slate-600">
              Get quick assistance for access, payments, classes, and technical
              issues.
            </p>
          </div>
      ...
      <section className="grid gap-3 sm:gap-4 xl:grid-cols-12">
        <article className="rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-4 sm:p-6 xl:col-span-7">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-lg md:text-sm text-slate-600">
              1 Day Response Time
            </p>
            <button
              type="button"
              onClick={() => setShowForm(true)}
              className="mt-6 inline-flex items-center justify-center rounded-xl bg-blue-600 px-8 py-3 text-sm md:text-sm font-semibold text-white transition hover:bg-blue-700 cursor-pointer">
              Get Support
            </button>
          </div>
        </article>
      ...
      {showForm && (
        <section
          id="contact-section"
          className="rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                className={fieldClass}>
                <option value="">Select</option>
                <option value="Data Analytics Mastery">
                  Data Analytics Mastery
                </option>
                <option value="DSA Pattern & CP">DSA Pattern & CP</option>
                ...
                <option value="DSA MAANG">DSA MAANG</option>
              </select>
            </div>
            <div />
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="min-h-30 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-blue-200 focus:bg-white focus:ring-4 focus:ring-blue-50"
              />
            </div>
